...
_DEMO_JOBS = [
    JobPosting(
        ...
        url="https://www.adzuna.de/jobs/details/demo-adzuna-001",
    ...
    JobPosting(
        ...
        url="https://www.arbeitsagentur.de/jobsuche/jobdetail/demo-ba-001",
    ...
    JobPosting(
        ...
        url="https://www.adzuna.de/jobs/details/demo-adzuna-002",
    ...
    JobPosting(
        ...
        url="https://www.arbeitsagentur.de/jobsuche/jobdetail/demo-ba-002",
    ...
    JobPosting(
        ...
        url="https://www.arbeitsagentur.de/jobsuche/jobdetail/demo-ba-003",
